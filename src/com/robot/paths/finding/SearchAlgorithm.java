package main.robot.paths.finding;
...
//                                    robotSize, 0)) {
    ...
    private static class NodeForSearch {
        private Node node;
        private double scoreF = 0;           //F
        private double scoreH = 0;           //H
...
//
//            seg0.setOriginX(this.node.getX() - radius * CurvesMath.cos(seg0.getStartAngle()));
//            // changed sign, because of screen coordinates
//            //seg0.setOriginY((double)coordinate.y-radius*CurvesMath.sin(seg0.getStartAngle()));
//            seg0.setOriginY(this.node.getY() + radius * CurvesMath.sin(seg0.getStartAngle()));
//
...
//
//            seg2.setOriginX(node.getX() - radius * CurvesMath.cos(radStopB));
//            // changed sign, because of screen coordinates
//            // seg2.setOriginY((double)node.getY()-radius*CurvesMath.sin(radStopB));
//            seg2.setOriginY(node.getY() + radius * CurvesMath.sin(radStopB));
//
...
//                        radStopA : Segment.capRadian(radStopA + CurvesMath.PI));
...
//                seg1.setOriginX(originX0 + radius * CurvesMath.cos(radStopA));
//                // changed sign, because of screen coordinates
//                //seg1.setOriginY(seg0.getOriginY() + radius* CurvesMath.sin(radStopA));
//                seg1.setOriginY(originY0 - radius * CurvesMath.sin(radStopA));
...
//                seg0.setLength(seg0.getRadiansTotal() * radius);
//                seg2.setStartAngle(isClockwiseA == isClockwiseB ?
//                        radStopB : Segment.capRadian(radStopB + CurvesMath.PI));
//                seg2.setRadiansTotal(0);
//                seg2.setLength(0);
//
//                // Finish information on the straight line segment (length already set above)
//                seg1.setIsStraightLine(true);
//                seg1.setOriginX(originX0 + radius * CurvesMath.cos(radStopB));
//                // changed sign, because of screen coordinates
//                //seg1.setOriginY(seg0.getOriginY() + radius* CurvesMath.sin(radStopA));
//                seg1.setOriginY(originY0 - radius * CurvesMath.sin(radStopB));
